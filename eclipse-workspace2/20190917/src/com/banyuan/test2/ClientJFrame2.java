...
public class ClientJFrame2 extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		ClientJFrame2 frame = new ClientJFrame2();
	}

	/**
	 * Create the frame.
	 */
	public ClientJFrame2() {
		setTitle("client2");
		...
		scrollPane_1.setBounds(6, 36, 145, -29);
		...
		try {
			s = new Socket("127.0.0.1", 10004, InetAddress.getByName("127.0.0.1"), 10002);
			...
			while(true) {
				...
				if (str != null) {
					//将文字打印到图形界面
			tareceive.append("port=" + s.getPort() + "localport=" + s.getLocalPort() + "接收的内容str=" + str+"\n");
				}
			}
		} catch (IOException e) {
			e.printStackTrace();
