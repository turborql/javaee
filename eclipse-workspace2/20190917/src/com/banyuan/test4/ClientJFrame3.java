...
public class ClientJFrame3 extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		ClientJFrame3 frame = new ClientJFrame3();
	}

	/**
	 * Create the frame.
	 */
	public ClientJFrame3() {
		setTitle("wangwu");
...
//		scrollPane_1.add(tareceive);
		...
		try {
			s = new Socket("127.0.0.1", 10005, InetAddress.getByName("127.0.0.1"), 10003);
