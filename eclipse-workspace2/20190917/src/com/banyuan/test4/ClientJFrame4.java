...
public class ClientJFrame4 extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		ClientJFrame4 frame = new ClientJFrame4();
	}

	/**
	 * Create the frame.
	 */
	public ClientJFrame4() {
		setTitle("zhaoliu");
...
//		scrollPane_1.add(tareceive);
		...
		try {
			s = new Socket("127.0.0.1", 10005, InetAddress.getByName("127.0.0.1"), 10004);
