					...
					<div class="user">
						...
						<div class="info">
							<a data-toggle="collapse" href="#collapseExample"
								aria-expanded="true"> <span> zhangsan<span
						...
						<li class="nav-item active"><a data-toggle="collapse"
							...
							<div class="collapse" id="dashboard">
								<ul class="nav nav-collapse">
									<li><a href="login.jsp"> <span class="sub-item">首页</span>
									</a></li>
									<li><a href="student.jsp"> <span class="sub-item">学生信息管理</span>
									</a></li>
									<li><a href="score.jsp"> <span class="sub-item">课程信息管理</span>
									</a></li>
								</ul>
							</div></li>
						...
						<div class="col-md-6">
							<div class="card full-height">
								<div class="card-body">
									...
									<div class="card-category">学生宿舍联系方式</div>
									<div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
										<div>
											<img src="images/1.jpg" width="70%" height="70%">
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-md-6">
							<div class="card full-height">
								<div class="card-body">
									...
									<div class="row py-3">
										<div
											class="col-md-12 d-flex flex-column justify-content-around">
											<div>
												<img src="images/2.jpg" width="70%" height="70%">
											</div>
